...
export const getComments = createAsyncThunk('comments/getComments', async ({ id, page }, { rejectWithValue }) => {
    try {
...
export const sendReply = createAsyncThunk('comments/sendReply', async (data, { rejectWithValue }) => {
    try {
